...
var isReferenceable = function(DB, r) {
    return isDocument(r) || isNativeId(DB, r);
};

var isNativeId = function(DB, n) {
...
var isType = function(DB, value, type) {
    if (type === String) {
